...
const MACOS_DOWNLOAD_URL =
  "https://github.com/teshikado/RoutineQuest/releases/latest/download/RoutineQuest-macOS.dmg";
  ...
  return (
    ...
    >
      ...
      <a
        href={href}
        download
        aria-label={`${buttonLabel} — startet den Download`}
        className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#A855F7] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-[#9333EA] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A855F7] focus-visible:ring-offset-2"
      >
  ...
  return (
    <div className={clsx("w-full max-w-2xl grid grid-cols-1 sm:grid-cols-2 gap-4", className)}>
      ...
      <DownloadCard
        ...
        extraNote="Unterstützt Apple Silicon und Intel"
        buttonLabel="Für macOS herunterladen"
