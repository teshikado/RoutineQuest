...
export default function ForgotPasswordPage() {
    ...
    return (
      <div className="text-center py-4">
        <div className="h-14 w-14 rounded-full bg-[#EAF7FC] flex items-center justify-center mx-auto mb-4">
          <CheckCircle2 className="h-7 w-7 text-[#4FA8D8]" />
        </div>
        <h1 className="text-xl font-bold text-[#183B56] mb-2">E-Mail unterwegs</h1>
        ...
        <Link href="/login" className="text-[#4FA8D8] font-semibold text-sm hover:underline">
  ...
  return (
    <>
      <h1 className="text-2xl font-bold text-[#183B56] mb-1">Passwort vergessen?</h1>
      <p className="text-sm text-[#5b7a91] mb-6">
