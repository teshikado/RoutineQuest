    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-extrabold text-[#183B56]">{stats.currentStreak}</div>
        ...
        <Card className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-extrabold text-[#183B56]">{stats.longestStreak}</div>
        ...
        <Card className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xl font-extrabold text-[#183B56]">{stats.thisWeekXp}</div>
          ...
          <ul className="space-y-2">
            {stats.frequentlySkipped.map((r) => (
              <li key={r.id} className="flex items-center gap-3">
                ...
                <div className="text-sm font-bold text-[#E2564C]">{Math.round(r.missRate * 100)}%</div>
              </li>
            ))}
          </ul>
        )}
